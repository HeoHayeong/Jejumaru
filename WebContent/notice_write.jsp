...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>JEJUMARU 공지사항 > 새글쓰기</title>
...
function chkSubmit(){
	...
	var title = frm["ntitle"].value.trim();
...
<ul class="nav navbar-nav ml-auto">
    ...
    <section>
        ...
        <form name = "frm" action="notice_writeOk.do" method="post" onsubmit="return chkSubmit()">
        ...
        %>
            <table>
                <tr>
                    <td style="text-align: left; color: gray; font-size: 14px;">운영자</td>                
                    <td style="text-align: right;  color: gray; font-size: 14px;"><%= nowdate  %></td>
                </tr>
                <tr>
                    <th colspan="2">
                    	<div class="inputTitle">
                    		<a>제목</a><input type = "text" name = "ntitle"/>
                    	</div>
                    </th>
                </tr>
                <tr> 
                    <td class="contentBox" colspan="2">
                    	<textarea name="ncontent" id="writeEdt"></textarea>
                        <script>

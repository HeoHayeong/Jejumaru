...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>JEJUMARU 공지사항 > 수정하기</title>

	<script src="notice/ckeditor/ckeditor.js"></script>
...
<link rel="stylesheet" href="Login/css/button.css">
    ...
    <link href="notice/assets/css/notice_update.css" rel="stylesheet" type="text/css">
...
function chkSubmit(){
	...
	var ntitle = frm["ntitle"].value.trim();
...
<ul class="nav navbar-nav ml-auto">
    ...
    <section>
        ...
        <form name = "frm" action="notice_updateOk.do" method="post" onsubmit="return chkSubmit()">
        <!-- hidden 타입으로 nno 넘겨줘야한다! -->
        <input type="hidden" name="nno" value="${notice_list[0].nno }"/>
        <div class="noticeTable">
            <table>
                <tr>
                    <td style="text-align: left; color: gray; font-size: 14px;">담당자</td>                
                    <td style="text-align: right;  color: gray; font-size: 14px;">${notice_list[0].nregDate }</td>
                </tr>
                <tr>
                    <th colspan="2">
                    	<input type = "text" name = "ntitle" value="${notice_list[0].ntitle} "/>
                    </th>
                </tr>
                <tr> 
                    <td colspan="2" class="contentBox" style="text-align: left;">
                    	<textarea name="ncontent" id="updateEdt">${notice_list[0].ncontent}</textarea>
                        <script>
                        
	                        CKEDITOR.replace('updateEdt', {

  ...
  <section>
    <div class="login-wrap">
      <div class="login-html">
          <input id="tab" type="radio" name="tab" class="sign-in" checked><label for="tab" class="tab" style="margin-left: 15px;" >회원 확인</label>
          <div class="member-form">
      <form name="frm" action="infochkOk.jsp"  method="post" onsubmit="return chkSubmit()">
            <div class="group">
                <label for="user" class="label" style="margin-top: 50px;">Existing ID</label>
                <input id="user" type="text" name="mid" class="input" placeholder="<%= (session.getAttribute("id"))  %>" disabled="disabled"/>
            </div>
            <div class="group">
                <label for="pass" class="label" style="margin-top: 50px;">Existing Password</label>
                <input id="pass" type="password" name="mpw" class="input" placeholder="기존 비밀번호"/>
                
            </div>
                 <div class="hr"></div>
                  <div class="group" style="margin: 50px auto;">
                      <input type="submit" class="button" value="확인" onclick="location.href='modify.do'"/>
                  </div>
                      </form>
                </div>
              </div>

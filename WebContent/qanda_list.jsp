...
<link rel="stylesheet" href="Login/css/button.css">
    ...
    <link href="QandA/assets/css/qanda_list.css" rel="stylesheet" type="text/css">
            	...
            	<div class="qandatabWrap">
					<table>
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach var="dto" items="${q_list }"> 
									<tr>
					...
					<c:if test="${sessionScope.id eq null }">
						<div class="comeJoin"><h3 style="color:gray;">로그인 후 질문 가능합니다.</h3></div>
					</c:if>

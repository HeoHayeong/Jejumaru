...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" href="List/list/css/styles.min.css?<%=System.currentTimeMillis() %>">
...
<ul class="nav navbar-nav ml-auto">
    ...
    <section class="py-5">
        <div class="container">
            ...
            <span class="d-inline-block mx-3 py-1 position-relative cateAll"><a class="text-dark text-decoration-none" href="list.do?cate=all&page=1">전체</a></span>
            <span class="d-inline-block mx-3 py-1 position-relative cateJeju"><a class="text-dark text-decoration-none" href="list.do?cate=jeju&page=1">제주시</a></span>
            <span class="d-inline-block mx-3 py-1 position-relative cateSeo"><a class="text-dark text-decoration-none" href="list.do?cate=seo&page=1">서귀포시</a></span>
                <span class="d-inline-block mx-3 py-1 position-relative cateIsland"><a class="text-dark text-decoration-none" href="list.do?cate=island&page=1">섬 속의 섬</a></span>
            </div>
    ...
    <script src="List/category.js?<%=System.currentTimeMillis() %>"></script>

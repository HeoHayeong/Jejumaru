...
<link rel="stylesheet" href="Login/css/button.css">
    ...
    <link href="notice/assets/css/notice_write.css" rel="stylesheet" type="text/css">
...
<ul class="nav navbar-nav ml-auto">
    ...
    <section>
        ...
        <form name = "frm" action="q_writeOk.do" method="post" onsubmit="return chkSubmit()">
        ...
        %>
            <table>
                <tr>
                    <td style="text-align: left; color: gray; font-size: 14px;"><%= session.getAttribute("id") %></td>                
                    <td style="text-align: right;  color: gray; font-size: 14px;"><%= nowdate  %></td>
                </tr>
                <tr>
                    <th colspan="2">
                    	<div class="inputTitle">
                    		<input type="hidden" name="qmno" value="<%= session.getAttribute("mno") %>"/>
                    		<a>제목</a><input type = "text" name = "qtitle"/>
                    	</div>
                    </th>
                </tr>
                <tr> 
                    <td class="contentBox" colspan="2">
                    	<textarea name="qcontent" id="writeEdt"></textarea>
                        <script>
							
                        	CKEDITOR.replace('writeEdt', {
